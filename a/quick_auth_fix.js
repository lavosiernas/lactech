// =====================================================
// CORREÇÃO RÁPIDA PARA PROBLEMAS DE AUTENTICAÇÃO
// =====================================================
...
async function createUserWithoutEmailConfirmation(email, password, userData) {
    try {
        console.log('Criando usuário sem confirmação de email...');
        ...
        console.log('Usuário criado no Supabase Auth:', authData);
        ...
        try {
            ...
            console.log('Erro no login direto:', loginError);
        }
...
async function authenticateUserImproved(email, password) {
    try {
        console.log('Tentando autenticação melhorada para:', email);
        ...
        if (authError) {
            ...
            // Se o erro for "Email not confirmed", criar sessão local
            if (authError.message.includes('Email not confirmed')) {
                console.log('Email não confirmado, criando sessão local...');
