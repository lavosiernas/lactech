-- =====================================================
-- REVERTER TODAS AS ALTERAÇÕES DO BANCO
-- =====================================================
...
-- 4. REMOVER COLUNAS ADICIONADAS NA TABELA USERS
ALTER TABLE users DROP COLUMN IF EXISTS report_farm_name;
ALTER TABLE users DROP COLUMN IF EXISTS report_farm_logo_base64;
ALTER TABLE users DROP COLUMN IF EXISTS report_footer_text;
ALTER TABLE users DROP COLUMN IF EXISTS report_system_logo_base64;

-- 5. REMOVER COLUNAS ADICIONADAS NA TABELA FARMS
ALTER TABLE farms DROP COLUMN IF EXISTS cnpj;
ALTER TABLE farms DROP COLUMN IF EXISTS city;
